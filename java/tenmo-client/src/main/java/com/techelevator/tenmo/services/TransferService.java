...
public class TransferService
{
	...
	{
		String url = BASE_URL + "/transfers" + transfer.getUserFrom();
		
		Transfer transferFrom = new Transfer();
		
		HttpEntity<Transfer> entity = makeEntity(transferFrom);
		Transfer userFromTransfer = restTemplate.postForObject(url, entity, Transfer.class);
		
		return userFromTransfer;
	}
		
		
	public Transfer Amount(Transfer transfer)
	{	
